      ...
      <Link href={`/products/${product.slug}`} className="block flex-1">
        <div className="relative">
          ...
          <Badge
            ...
            className="absolute top-2 left-2 max-w-[calc(100%-1rem)] text-[10px] font-bold bg-brand-black/70 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity"
          >
            {product.category}
          </Badge>
        </div>
