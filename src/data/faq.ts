...
export const faqItems: FAQ[] = [
  { id: "1", question: "What are advanced therapeutics?", answer: "Advanced therapeutics are clinical-grade compounds that support various bodily functions. Therapeutic medications can support weight management, recovery, hormonal balance, and longevity." },
  { id: "2", question: "How are these medications administered?", answer: "Most Americare Wellness medications are administered subcutaneously (under the skin) in the abdomen, thigh, or upper arm. Rotate injection sites. Clean site, pinch skin, inject at 90° angle. Dispose of syringe in sharps container." },
