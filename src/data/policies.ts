...
export const policySections: PolicySection[] = [
  {
    ...
    content: [
      "Medical services described on this website are provided through telehealth by licensed healthcare professionals affiliated with Americare Wellness LLC, a Florida-licensed healthcare clinic. Telehealth services are conducted in accordance with applicable Florida law, including Florida Statute §456.47.",
  ...
  },
  {
    ...
    content: [
      "Certain medications or therapeutic products available through our services may be prepared by a licensed compounding pharmacy pursuant to a prescription issued by a licensed healthcare provider affiliated with Americare Wellness LLC.",
